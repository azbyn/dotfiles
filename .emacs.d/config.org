...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'eaf-mode-hook
            (lambda () (interactive)
              ...
              ;; (define-key eaf-mode-map (kbd "-") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "0") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "=") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "C") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "D") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "F") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "G") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "H") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "I") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "J") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "K") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "L") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "S") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "T") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "Y") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "c") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "d") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "e") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "f") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "g") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "h") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "i") 'eaf-send-key)
              ...
              ;; (define-key eaf-mode-map (kbd "k") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "l") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "m") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "o") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "p") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "r") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "s") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "t") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "u") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "v") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "x") 'eaf-send-key)
              ;; (define-key eaf-mode-map (kbd "y") 'eaf-send-key)
