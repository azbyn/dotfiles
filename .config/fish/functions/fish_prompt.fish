...
function __bobthefish_start_segment_nospace -S -d 'Start a prompt segment'
  set -l bg $argv[1]
  set -e argv[1]
  set -l fg $argv[1]
  set -e argv[1]
...
function __bobthefish_prompt_vi -S -d 'Display vi mode'
  ...
  switch $fish_bind_mode
    case default
      ...
      __bobthefish_start_segment_nospace $__color_vi_mode_default
      echo -n 'N'
    case insert
      __bobthefish_start_segment_nospace $__color_vi_mode_insert
      echo -n 'I'
    case replace_one
      __bobthefish_start_segment_nospace $__color_vi_mode_replace
      echo -n 'R'
    case visual
      __bobthefish_start_segment_nospace $__color_vi_mode_visual
      echo -n 'V'
  end
end
...
function __bobthefish_maybe_display_colors -S
  ...
  __bobthefish_finish_segments
  __bobthefish_start_segment $__color_vi_mode_replace
  echo -ns vi_mode_replace ' '
  __bobthefish_finish_segments
...
function fish_prompt -d 'bobthefish, a fish theme optimized for awesome'
  ...
  switch "$theme_color_scheme"
    ...
    case 'terminal' 'terminal-dark*'
      ...
      set __color_vi_mode_replace          brred $colorfg --bold
    ...
    case 'zenburn'
      ...
      set __color_vi_mode_replace          $red $white --bold
    ...
    case 'base16-light'
      ...
      set __color_vi_mode_replace          $base08 $colorfg --bold
    ...
    case 'solarized-light'
      ...
      set __color_vi_mode_replace          $red $colorfg --bold
    ...
    case 'light'
      ...
      set __color_vi_mode_replace          $red[2] $grey[3] --bold
    ...
    case 'gruvbox'
      ...
      set -g __color_vi_mode_replace       $red[1] $bg[2] --bold
