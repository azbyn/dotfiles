...
" Google Dark - Modified scheme by azbyn (original by Seth Wright)
...
" if $SHLVL is 2 this should mean that ~/.config/colors/out/shell wasn't already called
"if !has('gui_running')
"  execute "silent ![ $SHLVL == 2 ] && sh ~/.config/colors/out/shell"
"endif
...
let s:gui0C        = "12A59C"
let g:base16_gui0C = "12A59C"
let s:gui0D        = "3971ED"
let g:base16_gui0D = "3971ED"
let s:gui0E        = "A36AC7"
let g:base16_gui0E = "A36AC7"
let s:gui0F        = "FBA922"
let g:base16_gui0F = "FBA922"
...
if has("nvim")
  ...
  let g:terminal_color_14 = "#12A59C"
...
"call <sid>hi("Visual",        s:gui07, s:gui0F, s:cterm07, s:cterm0F, "", "")
...
" Lua
call <sid>hi("luaIn", s:gui0E, "", s:cterm0E, "", "", "")
call <sid>hi("luaOperator", s:gui0E, "", s:cterm0E, "", "", "")

" Perl
"call <sid>hi("perlVarPlain", s:gui09, "", s:cterm0A, "", "", "")
"perlOperator
" call <sid>hi("perlStatementStorage", s:gui0E, "", s:cterm0E, "", "", "")
