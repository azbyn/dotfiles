# Generated by Powerlevel10k configuration wizard on 2021-03-23 at 21:23 EET.
...
() {
 ...
 # option to define custom colors and icons for different directory classes.
  ...
  #   typeset -g POWERLEVEL8K_DIR_WORK_SHORTENED_FOREGROUND=250
  ...
  typeset -g POWERLEVEL9K_RANGER_BACKGROUND=4
  # Custom icon.
  typeset -g POWERLEVEL9K_RANGER_VISUAL_IDENTIFIER_EXPANSION='R'
